...
let date2 = date.toString().substr(4, 11)
...
function addStar() {
  ...
  let data = {
    x: mouseX,
    y: mouseY,
    url: "https://cdn.glitch.global/63c872e5-8f6b-4b1a-b13d-3bd869977d11/starstamp.png?v=1729266131248",
    width: 80,
    height: 73,
  };
...
function addTape() {
  let data = {
    x: mouseX,
    y: mouseY,
    url: "https://cdn.glitch.global/2954acae-949a-4370-ac7a-9173c3257791/tape1010.png?v=1729294824469",
    width: 130,
    height: 130,
  };
  socket.emit("stamp", data);
